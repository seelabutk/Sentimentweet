            ...
            if (results.length > 0)
            {
                ...
                google.maps.event.addListener(infowindow, 'domready', function() {
                    ...
                    close_btn.css({
                        ...
                        right: '-10px', top: '-4px', // button repositioning
                        border: '7px solid #2CBD4C', // increasing button border and new color
                        'border-radius': '13px', // circular effect
                        'box-shadow': '0 0 5px #4CB939' // 3D effect to highlight the button
                    });
                });
            }
        });
