...
$(document).ready(function(){
    ...
    // below maybe gets removed
    $.getJSON("get_positions.php", { term: "#gop" }, function(results){
        for (i in results){
    ...
    function init()
    {
        ...
        new ThreejsLayer({map: map}, function(layer){
            ...
            points.forEach(function(point){
                ...
                attributes.a_alpha.value[index] = 0.1;
  ...
  if(fuse !== undefined) {
    ...
    for (i in results){
      ...
      li.onclick = function() {
        ...
        /*$.getJSON("get_positions.php?term=" + term, function(results){
            for (i in results){
                points.push(results[i]);
            }
            init();
